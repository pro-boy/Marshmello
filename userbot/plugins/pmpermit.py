...
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/07f00e6786043fe838fcd.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (str(CUSTOM_PMPERMIT)
                     if CUSTOM_PMPERMIT else "USERBOT PROTECTION YOU TRIGGERED MY MASTER'S PM THIS IS A ILLEGAL AND REGARDED CRIME; GO AND FUCK YOUR MOM")
USER_BOT_WARN_ZERO = "Fuck 👿 off Don't spam My Master's Pm,You have been block bol lawde aab kya karega behenchod"

botisnoob = Var.TG_BOT_USER_NAME_BF_HER
USER_BOT_NO_WARN = (
    "**Hello, This is MARSHMELLO userbot PROTECTION service ⚠️**\n\n"
    f"`My Master {DEFAULTUSER} is busy Right now leave Your Name,0 Reason and $1000 million Dollor you will reply On 10000 light years Just And Chill Till My Master Comes !` \n"
