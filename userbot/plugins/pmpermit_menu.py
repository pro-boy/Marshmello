...
PM = ("`Hello. You are accessing the availabe menu of My Master,`"
               f"{DEFAULTUSER}.\n"
               "__Let Me Give A Chance tell your problem👿.__\n"
               "**Choose one of the following reasons why you are here:**\n\n"
               "`1`. To chat with my master\n"
               "`2`. To Give Your Details.\n"
               "`3`. To Give Your Girlfriend's Number\n"
...
LWARN = ("**This is your last warning. DO NOT send another message else you will be Fucked By my master Or reported To telegram Choice Is Yours Now .**\n__Use__ `/start` __to go back to the main menu.__")
#---------------------------Constants-----------------------    
